...
8. **[Examples & Templates](docs/examples-and-templates.md)** - 2 production-ready project starters (SPA and SSR) and 8 specialized example templates, features breakdown, and project scaffolding instructions.
